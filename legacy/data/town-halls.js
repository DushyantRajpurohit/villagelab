...
/** Grid is 44x44 at every Town Hall; the playable border differs only cosmetically. */
export const GRID = 44;

/**
 * Builders available at a given TH. Players can also own the O.T.T.O hut and
 * the sixth builder via gems, so this is the *typical* ceiling, not a hard cap —
 * the planner lets you override it.
 */
export function defaultBuilders(th) {
