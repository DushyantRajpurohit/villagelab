...
export default function BasePage() {
  return (
    <main className="mx-auto w-full max-w-[1400px] p-5">
      <PageHead
        title="Base builder"
        sub={`A ${GRID}×${GRID} village grid for either village. Counts and footprints come from your hall level and are enforced as you draw, so a finished layout is always one you could actually build. Layouts are saved per village in this browser — nothing is uploaded.`}
      />
      <BaseWorkbench />
    </main>
  );
