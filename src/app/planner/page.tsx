...
export default function PlannerPage() {
  return (
    <main className="mx-auto w-full max-w-[1400px] p-5">
      <PageHead
        title="Upgrade planner"
        sub="The API does not expose building levels, so record what your village actually looks like once and every cost below follows from it. Queue what you want next and the scheduler models your builders, laboratory and hero altars as separate lanes."
      />
      <PlannerApp />
    </main>
  );
